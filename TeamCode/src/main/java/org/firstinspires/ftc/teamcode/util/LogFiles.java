...
import org.firstinspires.ftc.teamcode.DriveUtil.SampleTankDrive;
import org.firstinspires.ftc.teamcode.DriveUtil.StandardTrackingWheelLocalizer;
...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double ticksPerRev = Constants.DriveConstants.TICKS_PER_REV;
        public double maxRpm = Constants.DriveConstants.MAX_RPM;
        public boolean runUsingEncoder = Constants.DriveConstants.RUN_USING_ENCODER;
        public double motorP = Constants.DriveConstants.MOTOR_VELO_PID.p;
        public double motorI = Constants.DriveConstants.MOTOR_VELO_PID.i;
        public double motorD = Constants.DriveConstants.MOTOR_VELO_PID.d;
        public double motorF = Constants.DriveConstants.MOTOR_VELO_PID.f;
        public double wheelRadius = Constants.DriveConstants.WHEEL_RADIUS;
        public double gearRatio = Constants.DriveConstants.GEAR_RATIO;
        public double trackWidth = Constants.DriveConstants.TRACK_WIDTH;
        public double kV = Constants.DriveConstants.kV;
        public double kA = Constants.DriveConstants.kA;
        public double kStatic = Constants.DriveConstants.kStatic;
        public double maxVel = Constants.DriveConstants.MAX_VEL;
        public double maxAccel = Constants.DriveConstants.MAX_ACCEL;
        public double maxAngVel = Constants.DriveConstants.MAX_ANG_VEL;
        public double maxAngAccel = Constants.DriveConstants.MAX_ANG_ACCEL;
        ...
        public RevHubOrientationOnRobot.LogoFacingDirection LOGO_FACING_DIR = Constants.DriveConstants.LOGO_FACING_DIR;
        public RevHubOrientationOnRobot.UsbFacingDirection USB_FACING_DIR = Constants.DriveConstants.USB_FACING_DIR;
